...
//         title: Align(
//           alignment: Alignment.centerRight,
//           child: Text('تقييم التطبيق', style: TextStyle(color: Colors.indigo[900])),
//         ),
//         content: SingleChildScrollView(
//           child: Container(
//             width: 330.0, // Set your desired width here
//             child: Column(
...
//                       contentPadding: EdgeInsets.only(left: 260),
//                       labelText: 'تعليقك',
...
//           ),
//         ),
//         contentPadding: EdgeInsets.fromLTRB(0.0, 4.0,4.0, 0.0),
...
class MyMapAppUser extends StatefulWidget {
  @override
  _MapAppWebState createState() => _MapAppWebState();
}

class _MapAppWebState extends State<MyMapAppUser> {
